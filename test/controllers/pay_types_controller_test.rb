...
class PayTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pay_type" do
    assert_difference('PayType.count') do
      post pay_types_url, params: { pay_type: { description: @pay_type.description, name: @pay_type.name } }
    end
  ...
  test "should update pay_type" do
    patch pay_type_url(@pay_type), params: { pay_type: { description: @pay_type.description, name: @pay_type.name } }
